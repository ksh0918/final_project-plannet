...
public class BoardController {
    ...
    public ResponseEntity<List<Map<String, Object>>> commentListLoad(@RequestBody Map<String, Long> data) {
        Long num = data.get("boardNo");
        Long offsetNum = data.get("offsetNum");
        Long limitNum = data.get("limitNum");
        BoardDTO boardDTO = boardService.commentListLoad(num, offsetNum, limitNum);
        if(boardDTO.isOk()) {
